...
- [ ] Choose the Windows distribution format (fat JAR, Compose native package, or another verified option).
- [ ] Build a release artifact that includes the bundled JSON and license attribution.
